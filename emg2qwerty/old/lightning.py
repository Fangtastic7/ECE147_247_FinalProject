...
class TCNCTCModule(pl.LightningModule):
    ...
    def __init__(
        ...
        self.model[-2].bias.data[charset().null_class] = -2.0
    ...
    def _step(
        ...
        if self.global_step == 0:
            print("logit mean:", emissions.mean().item())
            print("logit std:", emissions.std().item())
        ...
        T_diff = inputs.shape[0] - emissions.shape[0]
        # emission_lengths = input_lengths - T_diff
        emission_lengths = input_lengths // 2
        ...
        blank_probs = emissions.exp()[..., blank_idx]
        print("blank prob mean:", blank_probs.mean().item())
