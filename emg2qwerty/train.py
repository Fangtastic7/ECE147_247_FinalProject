...
# 暴力破解：强制让 torch.load 默认不检查安全性
# 这能解决所有 PyTorch 2.6 的 UnpicklingError
...
torch.serialization.add_safe_globals([
    ...
    omegaconf.base.ContainerMetadata,  # 刚才卡在这里的“行李标签”
    omegaconf.base.Metadata,           # 预防性放行
    omegaconf.nodes.AnyNode            # 预防性放行
])
